...
public class SuaForm extends javax.swing.JDialog {

    public SuaForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        int result = JOptionPane.showConfirmDialog(null, "Bạn xác nhận muốn đổi tên đề tài?","Thông báo",JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SuaForm dialog = new SuaForm(new javax.swing.JFrame(), true);
