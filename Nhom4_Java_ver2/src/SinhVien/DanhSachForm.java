 ...
 * @author Le Thanh An
 */
public class DanhSachForm extends javax.swing.JFrame {
    public DanhSachForm() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DanhSachForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DanhSachForm().setVisible(true);
            }
        });
    }
